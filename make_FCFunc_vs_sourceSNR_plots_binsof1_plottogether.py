...
for regions_to_run in regions_to_run_list:
    ...
    cat_list = sorted(list(glob.glob(cat_dir+'/'+regions_to_run[0]+'*fits')))
    print(cat_list)
    ...
    brightness_threshes = {}
    brightness_threshes['IC348'] = {}
    brightness_threshes['NGC1333'] = {}
    brightness_threshes['NGC2024'] = {}
    brightness_threshes['NGC2071'] = {}
    brightness_threshes['OMC23'] = {}
    brightness_threshes['OPHCORE'] = {}
    ...
    for eachtargunc in target_uncertainties:
        ...
        for eachcat in cat_list:
            ...
            print('\n\n',region,'\n\n')
            var_list,var_names = get_vars(region)
            date_scans,noises = read450noise('noises_450.txt',region)
            if region in regions_to_run:
                ...
                cal_bright_index = np.where(peak_fluxes_sorted>=brightness_threshes[region][target_uncertainty_key])
                ...
                ax1.axvline(x=brightness_threshes[region][target_uncertainty_key],linestyle='dashed',color='k',linewidth=2,
    ...
    #                     verticalalignment='top', transform=ax1.transAxes, fontsize=4, bbox=props)
                ...
                SD_of_best_fam_for_plot,numcals_for_plot,colors_for_plot,\
                    ...
                    normfluxes_by_date_all= plot_SDfamsize(region,'450',str(100*eachtargunc))
    ...
    #                     verticalalignment='top', transform=ax3.transAxes, fontsize=4, bbox=props)
                ...
                cal_info_dict = {}
                cal_info_dict['family'] = 'blah'
                cal_info_dict['datescans'] = date_scans
